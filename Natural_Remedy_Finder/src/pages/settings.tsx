...
import { Bell, Lock, User as UserIcon  , Leaf} from 'lucide-react';
    ...
    <div className="min-h-screen bg-green-50 ">
        ...
        <div className="flex items-center">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="font-semibold text-lg hover:cursor-pointer" style={{ color: '#0E5E2E' }} onClick={() => navigate("/chatbot")}>Natural Remedy Finder</h1>
