        ...
        >
          ...
          >
            ...
            >
              ...
              <span onClick={() => navigate("/")} className="text-[#2E7D32] hover:cursor-pointer">Natural Remedies</span>
            </motion.div>
            ...
            >
              ...
              <span onClick={() => navigate("/")} className="text-[#2E7D32] hover:cursor-pointer">Holistic Practices</span>
            </motion.div>
            ...
            >
              ...
              <span onClick={() => navigate("/chatbot")}  className="text-[#2E7D32] hover:cursor-pointer ">AI-Powered Chat</span>
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
